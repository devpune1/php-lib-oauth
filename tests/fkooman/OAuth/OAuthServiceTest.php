    ...
    public function testGetAuthorize()
    {
        ...
        $this->assertSame(
            array(
                ...
                'Content-Length: 292',
                '',
                '{"getAuthorize":{"user_id":"admin","client_id":"test-client","redirect_uri":"https:\/\/localhost\/cb","scope":"post","request_url":"https:\/\/oauth.example\/authorize?client_id=test-client&response_type=code&redirect_uri=https%3A%2F%2Flocalhost%2Fcb&state=12345&scope=post","has_state":true}}',
            ),
